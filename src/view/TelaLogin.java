...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUsuario.setToolTipText("Insira o login");
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        // TODO add your handling code here:
        modelUsuario.setLogin(txtUsuario.getText());
        modelUsuario.setSenha(String.valueOf(txtSenha.getPassword()));

        if (IControllerUsuario.validarUsuarioController(modelUsuario)) {
            new TelaPrincipal().setVisible(true);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Usuario ou senha invalidos", "Atenção", JOptionPane.ERROR_MESSAGE);
        }
